      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Text(
              'Application refers to Bluetooth Device MAnager, the software program provided by the Company.\n',
            ),
            const Text(
                'Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Bluetooth Device Manager.\n'),
            const Text(
